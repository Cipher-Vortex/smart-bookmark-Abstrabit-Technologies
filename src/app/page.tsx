    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center space-y-8">
      <div className="space-y-4">
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter uppercase italic">
          The <span className="text-accent underline decoration-4 underline-offset-8">Hoard</span>
        </h1>
        <p className="text-xl md:text-2xl font-mono text-gray-400 max-w-2xl">
          A digital artifact cemetery for the links you'll never actually read.
        </p>
      </div>
